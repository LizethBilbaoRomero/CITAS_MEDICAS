                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/usuario/generarcitamedica.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Generar Citas Médicas</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/usuario/historial.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/usuario/editarperfil.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Editar Perfil</p>
                                    </a>
                                </li>
